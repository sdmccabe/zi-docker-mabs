...
for ((i=0; i<10; i++))
do 
{ /usr/bin/time -f "${threads},%e,%U,%S,%M" java -jar /models/scala/target/scala-2.11/ZIscala-assembly-1.0.jar -n 10000000 -a 100000 -t $threads ; } 2>> results/experiment-2/scala-benchmark.csv
done
done